                  ...
                  <div className="relative p-6">
                    <figure className="relative z-10">
                      <blockquote className="p-6 text-lg leading-relaxed">
                        <p>
                          "SynargyFit has completely transformed my relationship
                          with fitness. I used to feel intimidated by gyms, but
                          the supportive atmosphere and expert trainers at
                          SynargyFit made me feel welcome from day one. The
                          strength training classes have helped me build muscle,
                          lose weight, and feel stronger than ever before. I
                          highly recommend SynargyFit to anyone looking for a
                          fun and effective way to reach their fitness goals!"
                        </p>
                      </blockquote>
                  ...
                  <div className="h-full overflow-hidden rounded bg-white text-slate-500 shadow-2xl shadow-slate-200">
                    <div className="relative p-6">
                      <figure className="relative z-10">
                        <blockquote className="p-6 text-lg leading-relaxed">
                          <p>
                            "SynargyFit's Spinning classes are the perfect way
                            for me to de-stress and get a serious workout at the
                            same time. The instructors are motivating and the
                            music keeps me pushing myself. I love the group
                            setting and the feeling of accomplishment after each
                            class. Since joining SynargyFit, I've noticed a
                            significant improvement in my cardiovascular health
                            and endurance. Plus, it's just plain fun!"
                          </p>
                        </blockquote>
                        <figcaption className="flex flex-col items-start gap-2 p-6 pt-0 text-sm text-emerald-500">
                          <span
                  ...
                  <div className="h-full overflow-hidden rounded bg-white text-slate-500 shadow-2xl shadow-slate-200">
                    <div className="relative p-6">
                      <figure className="relative z-10">
                        <blockquote className="p-6 text-lg leading-relaxed">
                          <p>
                            "I never thought I'd enjoy yoga, but SynargyFit has
                            changed my mind! The instructors offer a variety of
                            classes to suit different needs and experience
                            levels. I started with Hatha yoga and have gradually
                            progressed to more challenging flows. Yoga at
                            SynargyFit has helped me become more flexible,
                            improve my balance, and reduce my stress levels.
                            It's the perfect way to unwind after a long day and
                            connect with my mind and body."
                          </p>
                        </blockquote>
                        <figcaption className="flex flex-col items-start gap-2 p-6 pt-0 text-sm text-emerald-500">
                          <span
